package com.graduate.tools.phone;
...
public class PhoneUtil {
    ...
    public static String getCarrier(String phoneNumber) {
        ...
        String carrierZh = "";
        if ("China Mobile".equals(carrierEn)) {
            carrierZh += "移动";
        } else if ("China Unicom".equals(carrierEn)) {
            carrierZh += "联通";
        } else if ("China Telecom".equals(carrierEn)) {
            carrierZh += "电信";
        }
        return carrierZh;
    }
    ...
    public static void main(String[] args) {
        PhoneModel phoneModel = PhoneUtil.getPhoneModel("17688883051");
        if(phoneModel != null){
