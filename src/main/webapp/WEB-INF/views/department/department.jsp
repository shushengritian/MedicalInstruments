...
<div style="height: 30px"></div>
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <input type="text" id="number" placeholder="科室编号" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-inline">
                <input type="text" id="name" placeholder="科室名称" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-inline">
                <input type="text" id="landline" placeholder="座机" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-inline">
                <select id="status">
                ...
                <%--<input type="text" name="exteriorValue" id="exteriorValue" placeholder="状态" autocomplete="off" class="layui-input">--%>
            </div>
            <div class="layui-inline">
